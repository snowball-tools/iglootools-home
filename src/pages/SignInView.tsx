        ...
        <div className="self-stretch flex flex-col gap-2 items-start">
          ...
          <div className="relative self-stretch flex flex-col">
            <input
              ...
              className="w-[342px] h-12 pl-5 pr-12 rounded-lg border-2 border-[rgba(182,236,226,0.16)] focus:border-[#b6ece2] bg-white text-sm font-sans tracking-wide leading-5"
              value={username}
